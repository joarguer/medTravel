...
$fields = ['name', 'email', 'timeline_from', 'timeline_to', 'destination', 'persons', 'category', 'special_request', 'origin', 'preselected_offer', 'preselected_service', 'phone', 'consent_terms', 'consent_privacy', 'consent_insurance', 'utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'utm_term'];
$input = [];
