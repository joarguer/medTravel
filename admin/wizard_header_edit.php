...
<html lang="es">
    <head>
        <meta charset="utf-8" />
        <title>medTravel - Wizard Header Edit</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-md">
            ...
            <div class="container-fluid">
                <div class="page-content">
                    <div class="breadcrumbs">
                        <h1>Booking Wizard Header Edit</h1>
                        <ol class="breadcrumb">
                            <li><a href="#">Site</a></li>
                            <li class="active">Booking Wizard Header (booking/wizard.php)</li>
                        </ol>
        ...
        <script src="js/wizard_header_edit.js" type="text/javascript"></script>
    </body>
</html>
