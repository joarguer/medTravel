...
function refreshOfferDetailData(callback){
    let url = 'ajax/offer_detail_edit.php';
    let data = {
        tipo: 'get_header'
    };
...
CREATE TABLE IF NOT EXISTS offer_detail_header (
...
function renderHeaderView(){
    if(!dataheader || !dataheader.id){
        ...
        let body = `
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="new_title" value="Medical Service Details" placeholder="Medical Service Details">
            </div>
            <div class="form-group">
                <label>Subtítulo 1 (Superior)</label>
                <input type="text" class="form-control" id="new_subtitle_1" value="OFFER DETAILS" placeholder="OFFER DETAILS">
            </div>
            <div class="form-group">
                <label>Subtítulo 2 (Descripción)</label>
                <input type="text" class="form-control" id="new_subtitle_2" value="Complete information about your medical service" placeholder="Complete information">
            </div>
            <div class="form-group">
    ...
    let title = dataheader.title || 'Medical Service Details';
    let subtitle_1 = dataheader.subtitle_1 || 'OFFER DETAILS';
    ...
    let body = `
        ...
        <div class="form-group">
            <label>Título Principal</label>
            <input type="text" onchange="editInputSubmit('title',${id})" class="form-control" id="title" value="${title}" placeholder="Medical Service Details">
        </div>
        <div class="form-group">
            <label>Subtítulo 1 (Superior)</label>
            <input type="text" onchange="editInputSubmit('subtitle_1',${id})" class="form-control" id="subtitle_1" value="${subtitle_1}" placeholder="OFFER DETAILS">
        </div>
        <div class="form-group">
            <label>Subtítulo 2 (Descripción)</label>
            <input type="text" onchange="editInputSubmit('subtitle_2',${id})" class="form-control" id="subtitle_2" value="${subtitle_2}" placeholder="Complete information">
        </div>
        <div class="form-group">
...
$(document).ready(function(){
    refreshOfferDetailData(renderHeaderView);
});
...
function editImg(id){
    let title = $('#title').val() || 'offer-detail-header';
    ...
    file.onchange = function(){
        ...
        $.ajax({
            url: 'ajax/offer_detail_edit.php',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
